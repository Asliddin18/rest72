...
/* app.post('/login', (req, res) => {
  ...
  connection.query(admins, (err, result) => {
    ...
    if (loginCheck) {
      ...
      res.status(503).send("qo`chqorvoy Token Xatoooo")
    }
  })
}) 
 */
